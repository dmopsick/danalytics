...
def calculate_dynamax_adventure_shiny_chance(has_shiny_charm, pokemon_name, num_encounters):
...
calculate_dynamax_adventure_shiny_chance(has_shiny_charm, pokemon_name, num_encounters)